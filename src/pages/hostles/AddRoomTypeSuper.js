...
const AddRoomTypeSuper = (props) => {
  document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";

  
  const breadcrumbItems = [
    { title: "Smart school", link: "#" },
    { title: "Add Room Type", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems('Add Room Type', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddRoomTypeSuper);