...
const AddPurposeReceptionist = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Purpose", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Purpose', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddPurposeReceptionist);