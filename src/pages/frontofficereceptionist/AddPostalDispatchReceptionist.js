...
const AddPostalDispatchReceptionist = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Postal Dispatch", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Postal Dispatch', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddPostalDispatchReceptionist);