...
const AddPostalReceiveReceptionist = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Postal Receive", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Postal Receive', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddPostalReceiveReceptionist);