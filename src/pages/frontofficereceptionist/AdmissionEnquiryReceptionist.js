...
const AdmissionEnquiryReceptionist = (props) => {
    ...
    const handleClick = () => {
        navigate('/add-admission-enquiry-receptionist');
    };
...
export default connect(null, { setBreadcrumbItems })(AdmissionEnquiryReceptionist);
