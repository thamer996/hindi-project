...
const AddMarksGradeTeacher = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Marks Grade", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Marks Grade', breadcrumbItems)
    })
                            ...
                            <Row className="mb-3">
                                ...
                                <div className="col-md-10">
                                    ...
                                    <option>Select</option>
                                        <option> General Pupose (Pass/Fail) </option>
...
export default connect(null, { setBreadcrumbItems })(AddMarksGradeTeacher);