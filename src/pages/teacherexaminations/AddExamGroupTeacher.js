...
const AddExamGroupTeacher = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Exam Group", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Exam Group', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddExamGroupTeacher);