...
const DesignAdmitCardTeacher = (props) => {
    ...
    useEffect(() => {
        props.setBreadcrumbItems('Design Admit Card', breadcrumbItems)
    })
    const handleClick = () => {
        ...
        <React.Fragment>
                ...
                <Row>
                    <div className="d-flex mb-2">
                        ...
                        <label className="col-form-label">Admit Card</label>
                    ...
                    <div className="d-flex justify-content-between  mb-2">
                        <div></div>
                        {/* Button */}
                        <button className="btn btn-primary" onClick={handleClick} >Add Admit Card</button>
                    </div>
                </Row>
                <Row>
                    <Col lg={12}>
                        <Card>
                            ...
                            <CardBody>
                                <CardTitle className="h4">Admit Card </CardTitle>
...
export default connect(null, { setBreadcrumbItems })(DesignAdmitCardTeacher);