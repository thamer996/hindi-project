...
const AddItemSupplierAdmin = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Item Supplier", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Item Supplier', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddItemSupplierAdmin);