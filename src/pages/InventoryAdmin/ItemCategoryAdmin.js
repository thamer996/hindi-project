...
const ItemCategoryAdmin = (props) => {
    ...
    const handleClick = () => {
        navigate('/add-item-category-admin');
    };
        ...
        <React.Fragment>
            ...
            <Row>
                ...
                <div className="d-flex justify-content-between  mb-2">
                    <div></div>
                    {/* Button */}
                    <button className="btn btn-primary" onClick={handleClick}>Add Item Category</button>
...
export default connect(null, { setBreadcrumbItems })(ItemCategoryAdmin);