...
const AddIssueItemAdmin = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Issue Item", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Issue Item', breadcrumbItems)
    })
            ...
            <Row>
              ...
              <p className="card-title-desc">
                ...
                <code>type</code>.
                            ...
                            <Row className="mb-3">
                                <label className="col-md-2 col-form-label">Issue To</label>
                                <div className="col-md-10">
                                    <select className="form-control">
                                        <option> Select </option>
                            ...
                            <Row className="mb-3">
                                <label className="col-md-2 col-form-label">Issue By</label>
                                <div className="col-md-10">
                                    <select className="form-control">
                                        <option> Select </option>
                                        <option> Joe Black </option>
                                        <option>Shivam Verma</option>
...
export default connect(null, { setBreadcrumbItems })(AddIssueItemAdmin);