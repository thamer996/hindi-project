...
const AddItemCategoryAdmin = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Item Category", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Item Category', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddItemCategoryAdmin);