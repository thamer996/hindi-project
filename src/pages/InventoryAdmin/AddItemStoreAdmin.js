...
const AddItemStoreAdmin = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Item Store", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Item Store', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddItemStoreAdmin);