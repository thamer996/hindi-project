...
const AddLeave = (props) => {
  ...
  useEffect(() => {
    props.setBreadcrumbItems('Add Category', breadcrumbItems)
  })
        ...
        <Card>
          ...
          {/*<CardTitle className="h4">Textual inputs</CardTitle>
            <p className="card-title-desc">
              ...
              <Row className="mb-3">
                <label className="col-md-2 col-form-label">Available Leave</label>
                <div className="col-md-10">
...
export default connect(null, { setBreadcrumbItems })(AddLeave);