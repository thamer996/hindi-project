...
const AddVideoTutorialTeacher = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Video Tutorial", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Video Tutorial', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddVideoTutorialTeacher);