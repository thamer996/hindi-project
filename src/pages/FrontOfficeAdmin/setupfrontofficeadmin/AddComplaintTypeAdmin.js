...
const AddComplaintTypeAdmin = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Complaint Type", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Complaint Type', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddComplaintTypeAdmin);