...
import DeleteModalTimeTableReceptionist from "./DeleteModalTimeTableReceptionist";




const ClassTimeTableReceptionist = props => {
  ...
  return (
    ...
    <React.Fragment>
      <DeleteModalTimeTableReceptionist
        show={deleteModal}
...
ClassTimeTableReceptionist.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ClassTimeTableReceptionist)
