...
const AddNew = (props) => {
    ...
    useEffect(() => {
        props.setBreadcrumbItems('Add New', breadcrumbItems)
    })
            ...
            <Row>
              ...
              <p className="card-title-desc">
                ...
                <code>type</code>.
                            ...
                            <label>Branch Database Detail</label>
                        ...
                        <div className="d-flex justify-content-center mt-3 mb-3"> {/* mt-3 adds margin top, mb-3 adds margin bottom */}
                            <button type="submit" className="btn btn-primary w-md">Verify&Save</button>
                        </div>
                    </Card>
                </Col>
            </Row>
...
export default connect(null, { setBreadcrumbItems })(AddNew);