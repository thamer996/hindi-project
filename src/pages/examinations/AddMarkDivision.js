...
const AddMarkDivision = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Marks Division", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Marks Division', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddMarkDivision);