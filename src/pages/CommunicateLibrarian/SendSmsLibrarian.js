...
import EmailSideBarLibrarianSms from "./EmailSideBarLibrarianSms";

const SendSmsLibrarian = (props) => {
...
export default connect(null, { setBreadcrumbItems })(SendSmsLibrarian);