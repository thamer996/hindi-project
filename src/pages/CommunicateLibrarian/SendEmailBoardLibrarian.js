...
import EmailSideBarBoardLibrarian from "./EmailSideBarBoardLibrarian";

const SendEmailBoardLibrarian = (props) => {
...
export default connect(null, { setBreadcrumbItems })(SendEmailBoardLibrarian);