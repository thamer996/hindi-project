...
const AddHostelAdmin = (props) => {
  document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";

  
  const breadcrumbItems = [
    { title: "Smart school", link: "#" },
    { title: "Add Hostel", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems('Add Hostel', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddHostelAdmin);