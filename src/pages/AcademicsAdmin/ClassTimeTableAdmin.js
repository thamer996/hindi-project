...
import DeleteModalTimeTableAdmin from "./DeleteModalTimeTableAdmin";



const ClassTimeTableAdmin = props => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ClassTimeTableAdmin)
