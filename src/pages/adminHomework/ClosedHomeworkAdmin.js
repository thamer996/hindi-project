...
const ClosedHomeworkAdmin = (props) => {
    ...
    useEffect(() => {
        props.setBreadcrumbItems('Closed Homework', breadcrumbItems)
    })
    const handleClick = () => {
        navigate('/add-closed-admin');
    };
...
export default connect(null, { setBreadcrumbItems })(ClosedHomeworkAdmin);