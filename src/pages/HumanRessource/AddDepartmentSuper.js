...
const AddDepartmentSuper = (props) => {
  document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";

  
  const breadcrumbItems = [
    { title: "Smart school", link: "#" },
    { title: "Add Department", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems('Add Department', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddDepartmentSuper);