...
const AddDesignationSuper = (props) => {
  document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";

  
  const breadcrumbItems = [
    { title: "Smart school", link: "#" },
    { title: "Add Designation", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems('Add Designation', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddDesignationSuper);