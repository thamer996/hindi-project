...
const AddClassAcademicTeacher = (props) => {
    ...
    useEffect(() => {
        props.setBreadcrumbItems('Add Class', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddClassAcademicTeacher);