        ...
        <React.Fragment>
            ...
            <Row>
                ...
                <div className="d-flex justify-content-between  mb-2">
                    <div></div>
                    {/* Button */}
                    <button className="btn btn-primary" onClick={handleClick} >Add Subject</button>
...
export default connect(null, { setBreadcrumbItems })(SubjectsTeacher);