...
import DeleteModalTeachersTable from "./DeleteModalTeachersTable";




const TeachersTimeTableTeacher = props => {
...
TeachersTimeTableTeacher.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TeachersTimeTableTeacher)
