...
const AddSectionTeacher = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Section", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Section', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddSectionTeacher);