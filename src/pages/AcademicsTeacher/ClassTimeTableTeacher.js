...
import DeleteModalTimeTable from "./DeleteModalTimeTable";



const ClassTimeTableTeacher = props => {
...
ClassTimeTableTeacher.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ClassTimeTableTeacher)
