...
const SubjectGroupTeacher = (props) => {
    ...
    const handleClick = () => {
        navigate('/add-subject-group-teacher');
    };
        ...
        <React.Fragment>
            ...
            <Row>
                ...
                <div className="d-flex justify-content-between  mb-2">
                    <div></div>
                    {/* Button */}
                    <button className="btn btn-primary" onClick={handleClick} >Add Subject Group</button>
...
export default connect(null, { setBreadcrumbItems })(SubjectGroupTeacher);