...
const AddFeesGroupAdmin = (props) => {
    document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";


    const breadcrumbItems = [
        { title: "Smart school", link: "#" },
        { title: "Add Fees Group", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('Add Fees Group', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddFeesGroupAdmin);