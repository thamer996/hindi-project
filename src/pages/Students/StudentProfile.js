                        ...
                        <CardBody>
                                    ...
                                    <Row>
                                        <Col xs="6">
                                            <address>
                                                ...
                                                <strong> Admission No</strong> :John Doe<br />
                                                <strong> Student Name:</strong>123-456-7890<br />
                                                <strong>Roll No:</strong>5656<br />
                                                <strong>Class:</strong>Grade 10<br />
                                                <strong>Father Name:</strong>Michael Doe <br />
                                                <strong>Date of Birth: </strong>2006-05-12<br />
                                        ...
                                        <Col xs="6" className="text-end">
                                            <address>
                                                <strong>Weight (Kg):</strong>70<br />
                                                <strong> Hight(cm):</strong>160<br />
                                                <strong> Blood Groop: </strong>A+<br />
                            ...
                            <Row>
                                <Col xs="12">
                                    <div>
                                        <div className="p-2">
                                            <h3 className="font-size-16"><strong>Attendance Logs</strong></h3>
                                        </div>
                                        <div className="">
                                                ...
                                                <table className="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td className="text-center"><strong>Arrive</strong>
                                                            </td>
                                                            <td className="text-end"><strong>Quit</strong></td>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
