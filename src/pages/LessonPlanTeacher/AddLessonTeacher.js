...
const AddLessonTeacher = (props) => {
  document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";

  
  const breadcrumbItems = [
    { title: "Smart school", link: "#" },
    { title: "Add Lesson", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems('Add Lesson', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddLessonTeacher);