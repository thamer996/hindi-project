...
import DeleteModalTeacher from "./DeleteModalTeacher";


const ManageLessonPlanTeacher = props => {
...
ManageLessonPlanTeacher.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageLessonPlanTeacher)
