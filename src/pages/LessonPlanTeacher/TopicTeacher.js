...
const Topic = props => {
  ...
  async function getTopic() {
    const { data, error } = await supabase.from("Topic").select("*").eq("brancheId",  localStorage.getItem("BranchId") ?? 1)
    if (data) {
            ...
            <Row>
              ...
              <div className="mb-3">
                ...
                <select
                  ...
                  invalid={
                    validation.touched.lessonName && validation.errors.lessonName
                      ? true
                      : false
                  }
                >
            ...
            {currData.map(el => (
              <li>
                <div>
                  ...
                  <span className="me-3"> Subject Group : {el.subjectGroup}</span>
