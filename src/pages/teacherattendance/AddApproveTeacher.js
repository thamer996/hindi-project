...
const AddApproveTeacher = (props) => {
    ...
    useEffect(() => {
        props.setBreadcrumbItems('Add Leave', breadcrumbItems)
    })
        ...
        <React.Fragment>
            ...
            <p className="card-title-desc">
              ...
              <code>type</code>.
                            ...
                            <Row className="mb-3">
                                <label className="col-md-2 col-form-label">Student</label>
                                <div className="col-md-10">
                                    <select className="form-control">
                                        <option> Select </option>
...
export default connect(null, { setBreadcrumbItems })(AddApproveTeacher);