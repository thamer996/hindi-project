...
const AddSchoolHouseSuper = (props) => {
  document.title = "Form Elements | Lexa - Responsive Bootstrap 5 Admin Dashboard";

  
  const breadcrumbItems = [
    { title: "Smart school", link: "#" },
    { title: "Add School House", link: "#" },
  ]

  useEffect(() => {
    props.setBreadcrumbItems('Add School House', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddSchoolHouseSuper);