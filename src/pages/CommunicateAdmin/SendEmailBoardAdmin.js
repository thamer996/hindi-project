...
import EmailSideBarBoardAdmin from "./EmailSideBarBoardAdmin";

const SendEmailBoardAdmin = (props) => {
...
export default connect(null, { setBreadcrumbItems })(SendEmailBoardAdmin);