...
const FileTypes = (props) => {
    ...
    const breadcrumbItems = [
        ...
        { title: "File Types", link: "#" },
    ]

    useEffect(() => {
        props.setBreadcrumbItems('File Types', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(FileTypes);