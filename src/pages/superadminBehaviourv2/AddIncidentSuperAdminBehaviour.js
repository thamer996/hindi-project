...
const AddIncidentSuperAdminBehaviour = (props) => {
  ...
  useEffect(() => {
    props.setBreadcrumbItems('Add Incident', breadcrumbItems)
  })
...
export default connect(null, { setBreadcrumbItems })(AddIncidentSuperAdminBehaviour);