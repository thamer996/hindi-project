...
const AddStudentLibrarian = (props) => {
    ...
    useEffect(() => {
        props.setBreadcrumbItems('Select Criteria', breadcrumbItems)
    })
...
export default connect(null, { setBreadcrumbItems })(AddStudentLibrarian);