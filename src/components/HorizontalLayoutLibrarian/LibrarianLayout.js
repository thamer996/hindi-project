...
import HeaderLibrarian from './HeaderLibrarian';

const LibrarianLayout = (props) => {
      ...
      <React.Fragment>
        ...
        <div id="layout-wrapper">
          <header id="page-topbar">
            <HeaderLibrarian theme={topbarTheme}
            ...
            <div className="top-navigation">
              ...
              <NavbarLibrarian menuOpen={isMenuOpened}/>
            </div>
          </header>
