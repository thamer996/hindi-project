              ...
              <ul className="navbar-nav">
                  ...
                  >
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        ...
                        <Link
                          to="/academics-assignteacher-admin"
                        ...
                        <Link
                          to="/promote-student-admin"
                          className="dropdown-item"
                        >
                          {props.t("Promote Students")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/subject-group-admin"
                          className="dropdown-item"
                        >
                ...
                >
                  ...
                  >
                    <li className="nav-item dropdown">
                      ...
                      >
                        <Link
                          to="/student-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Student Information")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/attendance-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Attendance")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/examination-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Examinations")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/lesson-syllabus-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Lesson Plan")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/staff-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Human Resource")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/homework-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Homework")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/book-issuereturn-report-admin"
                          className="dropdown-item"
                        >
                          {props.t("Library")} {props.menuOpen}
                        </Link>
                        <Link
                          to="/inventory-report-admin"
                          className="dropdown-item"
                        >
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      to="/settings-session-admin-admin"
                      className="dropdown-item"
                    >
