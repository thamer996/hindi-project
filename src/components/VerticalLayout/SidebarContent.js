          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/students">{props.t("View All Students")}</Link>
                </li>
                <li>
                  <Link to="/add-students">{props.t("Add Student")}</Link>
                </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/teachers">{props.t("View All Teachers")}</Link>
                </li>
                <li>
                  <Link to="/addteacher">{props.t("Add Teacher")}</Link>
                </li>
                
              </ul>
            </li>
            <li>
              <Link to="/classes" className=" waves-effect">
            ...
            <li>
              <Link to="/hostle" className=" waves-effect">
                ...
                <li>
                  <Link to="/ui-utilities">Log out</Link>
                </li>
                {/*
                <li>
