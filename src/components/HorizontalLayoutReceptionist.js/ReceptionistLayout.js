...
import NavbarReceptionist from './NavbarReceptionist';
import HeaderReceptionist from './HeaderReceptionist';
      ...
      <React.Fragment>
        ...
        <div id="layout-wrapper">
          <header id="page-topbar">
            <HeaderReceptionist theme={topbarTheme}
            ...
            <div className="top-navigation">
              ...
              <NavbarReceptionist menuOpen={isMenuOpened}/>
            </div>
          </header>
